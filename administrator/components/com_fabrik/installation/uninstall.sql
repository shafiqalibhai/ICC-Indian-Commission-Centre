DELETE FROM `#__fabrik_log`;
DROP TABLE `#__fabrik_log`;
...
DELETE FROM `#__fabrik_cron`;
DROP TABLE `#__fabrik_cron`;
DELETE FROM `#__fabrik_form_sessions`;
DROP TABLE `#__fabrik_form_sessions`;
