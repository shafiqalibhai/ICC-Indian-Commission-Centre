...
function checkFields(chk) {
	var form = document.adminForm;
	id = chk.inputElement.getProperty('id').substr(-1,1);	
	type = chk.inputElement.getProperty('id').slice(0,-1);

	if(id=="c") {
			form.getElementById(type+"b").checked=true;
			form.getElementById(type+"a").checked=true;
			FancyForm.select(form.getElementById(type+"1"));
			FancyForm.select(form.getElementById(type+"2"));			
	}
	if(id=="b") {
			form.getElementById(type+"a").checked=true;
			FancyForm.select(form.getElementById(type+"1"));			
...
function uncheckFields(chk) {
		var form = document.adminForm;
		id = chk.inputElement.getProperty('id').substr(-1,1);	
		type = chk.inputElement.getProperty('id').slice(0,-1);

	if(id=="c") {
			form.getElementById(type+"b").checked=false;
			form.getElementById(type+"a").checked=false;
			FancyForm.deselect(form.getElementById(type+"1"));
			FancyForm.deselect(form.getElementById(type+"2"));		
	}
	if(id=="b") {
			form.getElementById(type+"a").checked=false;
			FancyForm.deselect(form.getElementById(type+"1"));	
			form.getElementById(type+"c").checked=false;
			form.getElementById(type+"3").removeClass(FancyForm.onclasses[form.getElementById(type+"3").type]);
			form.getElementById(type+"3").addClass(FancyForm.offclasses[form.getElementById(type+"3").type]);
	}
	if(id=="a") {
			form.getElementById(type+"b").checked=false;
			form.getElementById(type+"c").checked=false;
			form.getElementById(type+"2").removeClass(FancyForm.onclasses[form.getElementById(type+"2").type]);
			form.getElementById(type+"2").addClass(FancyForm.offclasses[form.getElementById(type+"2").type]);
			form.getElementById(type+"3").removeClass(FancyForm.onclasses[form.getElementById(type+"3").type]);
			form.getElementById(type+"3").addClass(FancyForm.offclasses[form.getElementById(type+"3").type]);
	}	
}
...
window.addEvent('domready', function(){
	FancyForm.start( $$('.accessView input') , {
		onSelect: function(chk){
			chk.effects({duration: 500}).start({'color': '#FFF', 'background-color': '#FFF'});
			checkFields(chk);
		}, 
